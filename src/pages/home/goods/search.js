...
export default class GoodsSearch extends React.Component {
    ...
    // 显示筛选
    showScreen() {
        // 出现mask不让滑动页面,借助了ref监听touchmove操作阻止事件发生
                ...
                <div className={Css['goods-main']}>
                    {
                        ...
                        this.state.aGoods.map((item, index) => {
                            return <div className={Css['goods-list']} key={index}>
                    ...
                    <div>
                        ...
                        <div className={Css['attr-wrap']}>
                            <div className={Css['attr-title-wrap']} onClick={this.handlePrice.bind(this)}>
                                ...
                                <div className={this.state.aPrice.checked ? Css['attr-icon'] : Css['attr-icon'] + ' ' + Css['up']}></div>
                            </div>
                        ...
                        <div style={{width: '100%',height: '0.3rem', background: '#efefef'}}></div>
                        {
